...
class TenScore extends Component {
    constructor(){
        super()
        this.state={
            results:{"next_time":"2019-01-10 02:17:00","next_num":"20190110-1714","latest_num":"6109461094","latest_time":"2019-01-10 02:16:30","next_second":18,"history":[{"num":"20190110-1713","openTime":"2019-01-10 02:16:30","result":"6109461094"},{"num":"20190110-1712","openTime":"2019-01-10 02:16:00","result":"3600861094"},{"num":"20190110-1711","openTime":"2019-01-10 02:15:30","result":"6338861094"},{"num":"20190110-1710","openTime":"2019-01-10 02:15:00","result":"6516861094"},{"num":"20190110-1709","openTime":"2019-01-10 02:14:30","result":"3385261094"},{"num":"20190110-1708","openTime":"2019-01-10 02:14:00","result":"5344061094"},{"num":"20190110-1707","openTime":"2019-01-10 02:13:30","result":"1307061094"},{"num":"20190110-1706","openTime":"2019-01-10 02:13:00","result":"8870861094"},{"num":"20190110-1705","openTime":"2019-01-10 02:12:30","result":"3695161094"},{"num":"20190110-1704","openTime":"2019-01-10 02:12:00","result":"0943061094"}]},
            selectYear:'',
            selectMonth:'',
            selectDay:'',
            selectTime:{}
        ...
        <div className="App">
            ...
            <div className='TenScore-content' >
                <div className="TenScore-banner-div">
                    <div className='TenScore-banner' style={{backgroundImage:"url("+process.env.PUBLIC_URL+"/images/banner.jpg)"}}>
                       
                    </div>
                </div>
                <div className="TenScore-inner-content" >
                    <p className ="icon_title" style={{backgroundImage:"url("+process.env.PUBLIC_URL+"/images/MonacoSuper10.png)"}}></p>  
                                            ...
                                            <ul>
                                                {
                                                    this.splitNumber(item.result).map((item,index)=>{
                                                        return  <li key={index} style={{backgroundImage:"url("+process.env.PUBLIC_URL+"/images/ball.png)"}}>
                                                                <span>{item}</span>
                                                        </li> 
                                                    }) 
                                                }
